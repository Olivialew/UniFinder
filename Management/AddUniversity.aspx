...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center;">
        <span class="auto-style33"><strong>Add University</strong></span><br class="auto-style34" />
    </div>
    <strong>
        <br />
    </strong>
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtCampusTour" ErrorMessage="Incorrect link format for campus tour link" ForeColor="Red" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style28">&nbsp;</td>
        ...
        <tr>
            ...
            <td class="auto-style32">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtYouTube" ErrorMessage="Incorrect link format for youtube link" ForeColor="Red" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style30">&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtGoogleMaps" ErrorMessage="Incorrect link format for google maps link" ForeColor="Red" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?">*</asp:RegularExpressionValidator>
            </td>
        </tr>
    </table>
    </strong>
    ...
    <strong>
        ...
        <br />
        <div style="text-align: center;">
            <asp:Button ID="btnClearUni" runat="server" class="button" OnClick="btnCancel_Click" Text="Cancel" />
            &nbsp;<asp:Button ID="btnAddUniversity" runat="server" class="button" OnClick="btnAddUniversity_Click" Text="Submit" />
        </div>
        <br />
    </strong>
    <br />
