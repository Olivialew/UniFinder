        ...
        <asp:ListItem>Private university college</asp:ListItem>
                ...
                <div style="margin-top:30px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        ...
                        SelectCommand="SELECT * FROM [University] WHERE ((@uniType IS NULL OR @uniType = '' OR [uniType] = @uniType) AND (@uniNameEng IS NULL OR @uniNameEng = '' OR [uniNameEng] LIKE '%' + @uniNameEng + '%') AND (@uniNameMalay IS NULL OR @uniNameMalay = '' OR [uniNameMalay] LIKE '%' + @uniNameMalay + '%') AND (@uniAcronym IS NULL OR @uniAcronym = '' OR [uniAcronym] LIKE '%' + @uniAcronym + '%'))"
